                ...
                <div className="grid gap-6 xl:grid-cols-[420px_1fr]">
                  <aside className="space-y-6">
                    ...
                    <form
                      ...
                      className="max-h-[720px] overflow-y-auto rounded-xl border border-slate-800 bg-slate-900 p-5 pr-3 shadow-sm"
                    >
                      <h2 className="text-lg font-bold text-white">
                      ...
                      <div className="mt-4 grid gap-3">
                        ...
                        <Field label="Trial end date">
                          <DarkInput value={createTrialEndsAt} onChange={setCreateTrialEndsAt} type="date" />
                        </Field>

                        <Field label="Free months expiry">
                        ...
                        <div className="max-h-[520px] divide-y divide-slate-800 overflow-y-auto">
                          {users.map(user => (
                            <button
                              ...
                              className={`grid w-full gap-3 px-5 py-4 text-left hover:bg-slate-800 md:grid-cols-[1fr_120px_120px_130px] ${
                        ...
                        >
                          ...
                          <div className="mt-5 grid gap-4">
                            <Field label="Business name">
                              <DarkInput value={businessName} onChange={setBusinessName} />
                            </Field>

                            <Field label="Owner name">
                              <DarkInput value={ownerName} onChange={setOwnerName} />
                            </Field>

                            <Field label="Owner phone">
                              <DarkInput value={ownerPhone} onChange={setOwnerPhone} />
                            </Field>
                            ...
                            <Field label="Trial end date">
                              <DarkInput value={trialEndsAt} onChange={setTrialEndsAt} type="date" />
                            </Field>
                            ...
                            <Field label="Free months">
                              <DarkInput value={freeMonths} onChange={setFreeMonths} type="number" min="0" max="120" step="1" />
                            </Field>

                            <Field label="Free months expiry">
                              <DarkInput value={freeMonthsExpireAt} onChange={setFreeMonthsExpireAt} type="date" />
                            </Field>
                            ...
                            {(accountStatus === "Cancelled" || billingStatus === "Cancelled") && (
                              <Field label="Cancel reason">
                                <DarkTextarea value={cancelReason} onChange={setCancelReason} rows={4} />
                              </Field>
                            )}

                            <Field label="Support notes">
                              <DarkTextarea value={supportNotes} onChange={setSupportNotes} rows={6} />
                            </Field>

                            <Field label="Internal admin notes">
                              <DarkTextarea value={adminNotes} onChange={setAdminNotes} rows={5} />
                            </Field>
                            ...
                            >
                              {saving ? "Saving..." : "Save Customer Changes"}
                            </button>

                            {(selectedUser.accountStatus === "Cancelled" || selectedUser.billingStatus === "Cancelled") && (
                              <button
                                type="button"
                                onClick={handleReactivateCustomer}
                                disabled={saving}
                                className="rounded-lg border border-green-500/50 px-4 py-2 text-sm font-semibold text-green-200 hover:bg-green-500/10 disabled:cursor-not-allowed disabled:opacity-50"
                              >
                                Reactivate Customer
                              </button>
                            )}
                        ...
                        <div className="space-y-6">
                          <div className="rounded-xl border border-slate-800 bg-slate-900 p-5 shadow-sm">
                            ...
                            <div className="mt-4 grid gap-3 text-sm text-slate-400">
                              ...
                              <SnapshotRow label="Free months expiry" value={selectedUser.freeMonthsExpireAt ? formatDateTime(selectedUser.freeMonthsExpireAt) : "Not set"} />
                            ...
                            <div className="mt-4 space-y-4">
                              ...
                              <label className="flex items-center gap-2 text-sm text-slate-300">
                                <input
                                  ...
                                  onChange={event => setRequirePasswordReset(event.target.checked)}
                                />
                ...
                <div className="grid gap-6 xl:grid-cols-[420px_1fr]">
                  ...
                  <div className="space-y-6">
                    <StaffList
                      ...
                      onHeaderClick={() => setSelectedStaff(null)}
                      onAuditClick={searchAuditForStaff}
                      emptyText="No current staff found."
                    />
                    ...
                    <StaffList
                      ...
                      onHeaderClick={() => setSelectedStaff(null)}
                      onAuditClick={searchAuditForStaff}
                      emptyText="No previous staff found."
                    />
                    ...
                    {selectedStaff && (
                      ...
                      >
                        ...
                        <div className="mt-5 grid gap-4">
                          ...
                          {staffEditRole === "Personal Assistant" && (
                            <Field label="PA to">
                              <DarkInput
                                value={staffEditPaTo}
                                onChange={setStaffEditPaTo}
                                disabled={selectedStaff.email.toLowerCase() === permanentDirectorEmail}
                              />
                            </Field>
                          )}
                          ...
                          <PermissionEditor
                            ...
                            setPermissions={setStaffEditPermissions}
                            disabled={selectedStaff.email.toLowerCase() === permanentDirectorEmail}
                          />

                          <Field label="Internal staff notes">
                            <DarkTextarea value={staffEditNotes} onChange={setStaffEditNotes} rows={5} />
                          </Field>
                        </div>
