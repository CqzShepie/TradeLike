...
export const navigationConfig: NavigationItem[] = [
  ...
  { id: "billing", label: "Billing", path: "/settings/billing", icon: CreditCard, group: "billing-plan", feature: "billing", exactMatch: true, minimumPlan: "Solo", hiddenFromSidebar: true, settingSection: "Billing & Plan", requiredRoles: directorRoles, badge: "Director", description: "Subscription, plan and billing details." },
  { id: "usage", label: "Usage", path: "/settings/billing/usage", icon: Gauge, group: "billing-plan", feature: "usage", exactMatch: true, minimumPlan: "Solo", hiddenFromSidebar: true, settingSection: "Billing & Plan", requiredRoles: directorRoles, badge: "Director", description: "Feature and account usage." },
  ...
  { id: "full-data-export", label: "Full Data Export", path: "/settings/full-data-export", icon: Database, group: "data", feature: "full-data-export", exactMatch: true, minimumPlan: "Business", hiddenFromSidebar: true, settingSection: "Data", requiredRoles: directorRoles, badge: "Business+", description: "Director-only tenant data export." },
