...
namespace TradeLike.Api.Migrations
{
    ...
    [Migration("20260702230200_StorageAccountLimitsAndAddOns")]
    partial class StorageAccountLimitsAndAddOns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradeLike.Api.Models.BusinessSettings", b =>
                {
                    ...
                    b.Property<string>("DefaultQuoteNotes")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("DefaultReportRange")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                        .HasColumnType("nvarchar(40)")
                    ...
                    b.Property<string>("DefaultScheduleView")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)")
                    ...
                    b.Property<bool>("IncludeArchivedInReports")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IncludeCompletedInReports")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.Property<int>("QuoteExpiryDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(30);
            ...
            modelBuilder.Entity("TradeLike.Api.Models.Plan", b =>
                {
                    ...
                    b.Property<long?>("IncludedStorageBytes")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IncludedStorageBytes = 10000000000L,
                            MaxIncludedUsers = 1,
                            MonthlyPricePence = 3295,
                            Name = "Solo"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IncludedStorageBytes = 50000000000L,
                            MaxIncludedUsers = 10,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IncludedStorageBytes = 250000000000L,
                            MaxIncludedUsers = 25,
            ...
            modelBuilder.Entity("TradeLike.Api.Models.StorageAddOnPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long>("ExtraStorageBytes")
                        .HasColumnType("bigint");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "extra-50gb",
                            ExtraStorageBytes = 50000000000L,
                            IsActive = true,
                            Label = "Extra 50GB",
                            MonthlyPricePence = 495
                        },
                        new
                        {
                            Id = 2,
                            Code = "extra-100gb",
                            ExtraStorageBytes = 100000000000L,
                            IsActive = true,
                            Label = "Extra 100GB",
                            MonthlyPricePence = 895
                        },
                        new
                        {
                            Id = 3,
                            Code = "extra-250gb",
                            ExtraStorageBytes = 250000000000L,
                            IsActive = true,
                            Label = "Extra 250GB",
                            MonthlyPricePence = 1795
                        },
                        new
                        {
                            Id = 4,
                            Code = "extra-500gb",
                            ExtraStorageBytes = 500000000000L,
                            IsActive = true,
                            Label = "Extra 500GB",
                            MonthlyPricePence = 2995
                        },
                        new
                        {
                            Id = 5,
                            Code = "extra-1tb",
                            ExtraStorageBytes = 1000000000000L,
                            IsActive = true,
                            Label = "Extra 1TB",
                            MonthlyPricePence = 4995
                        });
                });

            modelBuilder.Entity("TradeLike.Api.Models.StorageObject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ParentStorageObjectId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParentStorageObjectId");
            ...
            modelBuilder.Entity("TradeLike.Api.Models.StorageUsageEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradeLike.Api.Models.TenantStorageAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long?>("ManualStorageOverrideBytes")
                        .HasColumnType("bigint");

                    b.Property<long>("PurchasedStorageBytes")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TenantStorageAccounts");
                });

            modelBuilder.Entity("TradeLike.Api.Models.TenantStorageAddOn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("StorageAddOnPlanId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StorageAddOnPlanId");

                    b.HasIndex("StripeSubscriptionId");

                    b.HasIndex("TenantId", "Status");

                    b.ToTable("TenantStorageAddOns");
                });
            ...
            modelBuilder.Entity("TradeLike.Api.Models.StorageObject", b =>
                {
                    b.HasOne("TradeLike.Api.Models.StorageObject", "ParentStorageObject")
                        .WithMany()
                        .HasForeignKey("ParentStorageObjectId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ParentStorageObject");
                });

            modelBuilder.Entity("TradeLike.Api.Models.StorageUsageEvent", b =>
                {
                    b.HasOne("TradeLike.Api.Models.StorageObject", "StorageObject")
                        .WithMany()
            ...
            modelBuilder.Entity("TradeLike.Api.Models.TenantStorageAccount", b =>
                {
                    b.HasOne("TradeLike.Api.Models.User", "Tenant")
                        .WithOne()
                        .HasForeignKey("TradeLike.Api.Models.TenantStorageAccount", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TradeLike.Api.Models.TenantStorageAddOn", b =>
                {
                    b.HasOne("TradeLike.Api.Models.StorageAddOnPlan", "StorageAddOnPlan")
                        .WithMany()
                        .HasForeignKey("StorageAddOnPlanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("StorageAddOnPlan");
                });
